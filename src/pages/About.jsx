  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Web developer from Nepal, specializing in designing and development of
          seo-friendly and attractive web app.
        </p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            I have worked on couple of combined projects with developer from
            different companies, leveling up my skills and teaming up with smart
